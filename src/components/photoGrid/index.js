...
export const getDifferent_2018 = () => {
  const [currentImage, setCurrentImage] = useState(0);
  const [viewerIsOpen, setViewerIsOpen] = useState(false);
  ...
  return (
    <section className="photo">
      <Gallery photos={different_2018} onClick={openLightbox} />
      <ModalGateway>
        {viewerIsOpen ? (
          <Modal onClose={closeLightbox}>
            <Carousel
              currentIndex={currentImage}
              views={different_2018.map(x => ({
                ...x,
                srcset: x.srcSet,
                caption: x.title,
              }))}
...
export const getDifferent_2019 = () => {
  const [currentImage, setCurrentImage] = useState(0);
  const [viewerIsOpen, setViewerIsOpen] = useState(false);
  ...
  return (
    <section className="photo">
      <Gallery photos={different_2019} onClick={openLightbox} />
      <ModalGateway>
        {viewerIsOpen ? (
          <Modal onClose={closeLightbox}>
            <Carousel
              currentIndex={currentImage}
              views={different_2019.map(x => ({
                ...x,
                srcset: x.srcSet,
                caption: x.title,
              }))}
...
export const getDifferent_2020 = () => {
  const [currentImage, setCurrentImage] = useState(0);
  const [viewerIsOpen, setViewerIsOpen] = useState(false);
  ...
  return (
    <section className="photo">
      <Gallery photos={different_2020} onClick={openLightbox} />
      <ModalGateway>
        {viewerIsOpen ? (
          <Modal onClose={closeLightbox}>
            <Carousel
              currentIndex={currentImage}
              views={different_2020.map(x => ({
                ...x,
                srcset: x.srcSet,
                caption: x.title,
              }))}
